...
public interface LockService {
    ...
    default void acquire(String scope, String key) {
        while (!tryAcquire(scope, key)) {
            try {
                Thread.sleep(50);
            }
    ...
    AutoCloseable subscribe(String channel, java.util.function.Consumer<String> handler);
}
