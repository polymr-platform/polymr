...
@Path("/api/tenants/{tenantId}/workspaces/{workspaceId}/attachments")
public class PublicAttachmentResource {
	@Inject
	...
	public Response load(
		...
		if (!asset.workspaceId().equals(workspaceId)) {
			throw new WebApplicationException("Invalid token", Response.Status.NOT_FOUND);
		}
		...
		StoredBlob blob = blobStore.load(workspaceId, asset.hash())
